package io.reqres.apis.stepdefs;
...
import io.reqres.apis.services.impl.UserServiceImpl;
...
public class UserSteps {
    ...
    public void user_provides_following_information_for_registration(List<Map<String,String>> userRegistrationMap) throws IOException {
    ...
    public void user_information_should_be_available_with_below_details(List<Map<String,String>> userInformationMap) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
